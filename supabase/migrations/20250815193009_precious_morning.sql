...
CREATE TABLE IF NOT EXISTS content (
  ...
  price_eth decimal NOT NULL DEFAULT 0.00001,
...
-- Add at the end of your migration file or run in Supabase SQL editor

create or replace function set_wallet_address(address text)
returns void as $$
begin
  perform set_config('app.current_wallet_address', address, true);
end;
